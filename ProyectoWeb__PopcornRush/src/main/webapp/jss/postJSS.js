...
// Obtener el ID del post desde algún lugar en la página
    ...
    // Verificar si el post está anclado
    const isAnclado = document.body.dataset.anclado === "true";
    console.log("¿Post anclado?:", isAnclado);
    if (!isAnclado) {
...
// Hacer la solicitud POST para enviar el comentario
        ...
        console.log("Este post está anclado. No se mostrarán los comentarios.");
    }
});
